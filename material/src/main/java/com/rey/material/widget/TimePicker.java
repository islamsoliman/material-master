    ...
    public void draw(Canvas canvas) {
        ...
        if(!mRunning){
            ...
            for(int i = 0; i < length; i++) {
                ...
                canvas.drawText(TypefaceUtil.getArNum(mTicks[index]), mLocations[index * 2], mLocations[index * 2 + 1], mPaint);
            }
        }
        else{
            ...
            for(int i = 0; i < outLength; i++){
                ...
                canvas.drawText(TypefaceUtil.getArNum(mTicks[index]), x, y, mPaint);
                angle += step;
            }
